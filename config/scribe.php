...
return [
    ...
    'auth'                             => [
        ...
        // Most of your endpoints require auth
        'default'     => 'bearer',

        // Bearer token via Authorization header
        'in'          => AuthIn::HEADER->value,

        // MUST be Authorization (not key)
        'name'        => 'Authorization',

        // Optional: auto-fill token for Scribe "Try it out"
        'use_value'   => env('SCRIBE_AUTH_TOKEN'),

        // Placeholder shown in docs
        'placeholder' => 'Bearer {YOUR_TOKEN}',

        'extra_info'  => 'Use the token received from the login API.',
    ],
